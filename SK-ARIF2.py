...
class Main:
	def __init__(self):
		...
		self.loop = 0
		os.system("clear")
		print('\x1b[1;92m SK ARIF')
		os.system("figlet SK ARIF")
		print("\n\t [Code By With SK ARIF] ") 
		print("\n [01]. crack random id facebook old")
		print(" [02]. report")
		tanya = input("\n [•] choose : ")
		if tanya in ["", " "]:
			Main()
		    ...
		    os.system(" xdg-open https://t.me/Prof_aec1")
		    time.sleep(3)		    		   
		    Main()
		else:
			Main()
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print(" [•] GITHUB : https://github.com/SK-ARIF404SK/SK-ARIF.git")
		exit()
	else:
		Main()
